...
//            @Override
//            public void onClick(View v) {
//                String idclass = btnjoin.getText().toString().trim(); // Lấy nội dung từ EditText
//                if (!idclass.isEmpty()) { // Kiểm tra nội dung có rỗng không
//                    cardAdapter.insertCard(idclass); // Gửi bài đăng vào adapter để xử lý
//                    finish(); // Đóng màn hình sau khi đăng
//                } else {
//                    Toast.makeText(JoinActivity.this, "Nội dung không được để trống!", Toast.LENGTH_SHORT).show(); // Hiển thị thông báo lỗi
//                }
//            }
//        });
//    }
